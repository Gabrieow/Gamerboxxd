...
use PDO;
    ...
    class JogoDAO {
        ...
        public function atualizar(Jogo $jogo) {
            $sql = "UPDATE jogos 
                    SET nome = :nome, categoria = :categoria, plataforma = :plataforma, desenvolvedor = :desenvolvedor,
                        data_lancamento = :data_lancamento, imagem_url = :imagem_url, descricao = :descricao 
                    WHERE id = :id";
